<script lang="ts">
	...
	import { deleteUrl } from './UrlStore.svelte';
...
<div class="p-3">
	<div class="card preset-filled-surface-100-900 p-4">
		...
		<div
			class="flex max-w-full items-center justify-between rounded-md border border-gray-800 bg-white px-4 py-3 font-mono text-sm text-gray-800"
		>
