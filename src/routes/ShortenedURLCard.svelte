<div class="card preset-filled-surface-100-900 p-4">
	...
	<div
		class="justify-center rounded-md border border-gray-800 bg-white px-3 py-3 font-mono text-sm text-gray-800"
	>
		<span class="flex h-3 w-3 cursor-pointer text-gray-800 duration-200 hover:text-gray-400">
			<svg
				class="fill-current"
				version="1.1"
				id="Layer_1"
